"""
Django settings for MyPortfolioBase project.
...
SECRET_KEY = 'django-insecure-5e4ldjx+1^62g!0xuru*-xqpjo37c2o8&od*e%=)ni!4+ww^$5'
...
INSTALLED_APPS = [
    "PropertiesApp.apps.PropertiesAppConfig",
...
ROOT_URLCONF = 'MyPortfolioBase.urls'
...
WSGI_APPLICATION = 'MyPortfolioBase.wsgi.application'
